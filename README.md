...
원본 스크린샷처럼 낮은 해상도로 뭉개진 한국어 흑백 비트맵 폰트입니다. `가`부터 `힣`까지 완성형 한글 11,172자를 실제 한국어 폰트에서 작게 래스터라이즈한 뒤 흑백 픽셀로 저장합니다.
...
이 폰트는 인쇄용 폰트보다 레트로 UI, 게임 HUD, 저해상도 디스플레이, 글리치 그래픽에 어울립니다. 각 글리프는 Windows의 Malgun Gothic Bold를 아주 작게 래스터라이즈한 뒤 흑백 픽셀로 임계처리해 생성합니다.
